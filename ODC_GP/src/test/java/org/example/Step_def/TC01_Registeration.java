...
public class TC01_Registeration {
    ...
    @And("Enter the first name") //choose your first name
    public void enter_the_first_name() {
        registeration.First_Name().sendKeys("Tarek");
    }
    @And("Enter the last name") //choose your last name
    ...
    @And("Enter your valid Email") //valid email
    public void enter_your_valid_email() {
        registeration.Email().sendKeys("tarek@gmail.com");
    }
    ...
    @And("Enter a new valid password") // enter your valid password
    public void enter_a_new_valid_password() {
        registeration.New_password().sendKeys("123456");
        registeration.Confirm_password().sendKeys("123456");
    }

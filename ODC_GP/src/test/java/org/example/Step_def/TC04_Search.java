...
public class TC04_Search {
    ...
    @When("Enter a valid data to login to the home page")
    public void enter_a_valid_data_to_login_to_the_home_page() {
        search_obj.login_before().click(); //to go to login page
        search_obj.Email().sendKeys("tarek@gmail.com"); //mail
        search_obj.password().sendKeys("123456");     //password

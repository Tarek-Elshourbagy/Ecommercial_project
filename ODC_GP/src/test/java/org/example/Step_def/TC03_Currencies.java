...
public class TC03_Currencies {
    ...
    @And("make sure that you enter a valid password and Email to enter to the home page successfully")
    public void login_by_valid_data() {
        concurrency_obj.login_before().click(); //to go to login page
        concurrency_obj.Email().sendKeys("tarek@gmail.com"); //mail
        concurrency_obj.password().sendKeys("123456");     //password
